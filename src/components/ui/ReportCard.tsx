        ...
        <>
          ...
          <div className='flex items-start justify-between gap-3 mb-2'>
            <div className='flex items-center gap-3 min-w-0'>
              ...
              <div className='flex items-center gap-1 text-gray-900 shrink-0'>
                <MapPin className='text-gray-400' size={11} />
          ...
          <div className='flex items-center justify-between mt-3 pt-3 border-t border-gray-50'>
            <div className='flex items-center gap-2'>
              <div className='w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-gray-50 border border-gray-200 flex items-center justify-center text-[10px] font-bold text-gray-600'>
              ...
              <div className='flex gap-1.5 sm:gap-2'>
                {report.status === "Menunggu" && (
                  <button
                    ...
                    className='p-1.5 sm:p-2 hover:bg-gray-100 rounded-xl text-gray-400 hover:text-gray-900 transition-all'
                    title='Terima'
                  >
                    <Check size={16} />
                  </button>
                ...
                {report.status === "Progres" && (
                  <button
                    ...
                    className='p-1.5 sm:p-2 bg-gray-900 text-white rounded-xl shadow-md transition-all hover:bg-black'
                    title='Selesai'
                  >
                    <CheckCircle size={16} />
                  </button>
