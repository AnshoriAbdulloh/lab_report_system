...
import { ClipboardList, Eye, EyeOff, LogIn, AlertCircle, Sun, Moon } from "lucide-react";
      ...
      >
        ...
        <div className="text-center mb-8">
          <div className="w-14 h-14 bg-gray-900 dark:bg-zinc-100 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-xl shadow-gray-200 dark:shadow-zinc-950/40">
            <ClipboardList className="text-white dark:text-zinc-900" size={28} />
          </div>
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-[2rem] sm:rounded-[2.5rem] border border-gray-100 dark:border-zinc-800 shadow-2xl shadow-gray-100/60 dark:shadow-zinc-950/40 overflow-hidden transition-all">
          ...
          <div className="px-6 sm:px-8 pt-6 sm:pt-8 pb-4 sm:pb-5 border-b border-gray-50 dark:border-zinc-800 bg-[#FAFAFA] dark:bg-zinc-900/50">
            <h2 className="font-bold text-lg text-gray-900 dark:text-zinc-100">Masuk</h2>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-[11px] font-bold text-gray-700 dark:text-zinc-300">user</p>
                      <p className="text-[9px] text-gray-400 dark:text-zinc-500 font-medium">user123</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-[11px] font-bold text-gray-700 dark:text-zinc-300">teknisi</p>
                      <p className="text-[9px] text-gray-400 dark:text-zinc-500 font-medium">teknisi123</p>
                    </div>
                  </div>
